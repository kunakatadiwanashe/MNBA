...
export default function FixturesPage() {
  ...
  const teamLogos: Record<string, string> = {
    ...
    "Vic Falls Panthers": "/logos/panthers.png",
  };
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white">
      <div className="bg-[#1565C0] flex items-center justify-between px-6 py-4">
        <h1 className="text-xl font-bold tracking-wide">🏀 MNBA Fixtures</h1>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        {fixtures.map((fixture, index) => (
          <motion.div
            key={fixture.id}
            layout
            className="bg-[#1E1E1E] rounded-lg shadow-md mb-6 p-4"
          >
            <div
            ...
            >
              <div>
                <h2 className="text-lg font-bold">{fixture.date}</h2>
